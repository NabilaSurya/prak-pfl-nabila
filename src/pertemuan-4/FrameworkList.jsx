  ...
  return (
    <div className="min-h-screen bg-slate-50 p-8 font-sans">
      ...
      <div className="max-w-6xl mx-auto mb-12 text-center">
        ...
        <p className="text-slate-500">Koleksi teknologi terbaik untuk membangun masa depan.</p>
      </div>
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {frameworkData.map((item) => (
          <div 
            key={item.id} 
            className="group relative bg-white border border-slate-200 rounded-3xl p-6 transition-all duration-300 hover:shadow-[0_20px_50px_rgba(8,_112,_184,_0.1)] hover:-translate-y-6 overflow-hidden"
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm text-slate-400 mb-4 font-medium">by {item.details.developer}</p>
